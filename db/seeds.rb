Supplier.create(name: "Steve's Stabby Stuff", email: "Steve@sss.com", phone_number: "919-555-5555")
Supplier.create(name: "We Sell Bows", email: "contact@wsb.com", phone_number: "919-444-4444")
...
Image.create(image_url: "https://cdn.reliks.com/products/341/750x280/1.jpg", product_id: 1)
Image.create(image_url: "https://i.ebayimg.com/images/g/T5UAAOSw-0xYPuO5/s-l1600.jpg", product_id: 2)
Image.create(image_url: "https://vignette.wikia.nocookie.net/finalfantasy/images/9/9a/Buster_sword_2_FF7.png/revision/latest?cb=20100611221609", product_id: 3)
Image.create(image_url: "http://i1021.photobucket.com/albums/af332/Alkariender/MMOs/SunstridersLongbow.png", product_id: 4)
Image.create(image_url: "http://dl36mmdz94630.cloudfront.net/uploads/assets/images/000/029/163/large/MS1.jpg?1430242360", product_id: 5)
