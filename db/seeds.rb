...
Product.create!([
  ...
  {name: "test", price: "1000.0", description: "test description", stock: nil, supplier_id: 1},
  {name: "test2", price: "20000.0", description: "hopefully this workds", stock: nil, supplier_id: 1},
  {name: "test-icles", price: "1000.0", description: "test description", stock: nil, supplier_id: 2},
  {name: "test tubes", price: "20000.0", description: "hopefuly works", stock: nil, supplier_id: 1}
])
